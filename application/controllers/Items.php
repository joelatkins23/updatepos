	...
	function save_inventory($item_id=-1)
	{
		...
		else
		{
			...
			(
				...
				'trans_max_order_qty'=>$this->input->post('max_order_qty'),
				'location_id'=>$location_id,
			...
			if($this->Item_location->save_quantity(($cur_item_location_info->quantity ? $cur_item_location_info->quantity : 0) + ($this->input->post('add_subtract') ? $this->input->post('add_subtract') : 0),$item_id,$max_order_qty))
			{
				//Ecommerce
				if (isset($this->ecom_model))
				{
