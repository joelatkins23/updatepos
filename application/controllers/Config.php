...
class Config extends Secure_area 
{
	...
	function save()
	{
      ...
      curl_close($ch);		
		...
		'reorder_level_select' => $this->input->post('reorder_level_select'),
		'default_reorder_level_when_creating_items' => $this->input->post('default_reorder_level_when_creating_items'),
		'default_percentage_when_creating_items' => $this->input->post('default_percentage_when_creating_items'),
		'default_price_when_creating_items' => $this->input->post('default_price_when_creating_items'),
