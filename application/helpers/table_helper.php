...
function get_items_manage_table($items,$controller)
{
	...
	$table='<table class="table table-report -mt-2" id="sortable_table">';	
	...
	if(!$params['deleted'])
	{
		$table_data_row.='<td class="actions">
							<div class="dropdown relative"> 
								<button class=" button flex bg-theme-3 text-white"><a href="'.site_url($controller_name."/view/$item->item_id?redirect=items").'"></a>'.lang('common_edit').'&nbsp; |<i data-feather="more-horizontal" class="dropdown-toggle" data-toggle="dropdown" aria-expanded="false"></i> </button>
								
								<div class="dropdown-box mt-12 absolute w-40 top-0 left-0 z-20">
									<div class="dropdown-box__content box">
										<div class="p-2"> 
											<a href="'.site_url($controller_name."/inventory/$item->item_id?redirect=items").'" class="flex items-center block p-2 transition duration-300 ease-in-out bg-white hover:bg-gray-200 rounded-md"> <i data-feather="printer" class="w-4 h-4 text-gray-700 mr-2"></i> '.lang('items_edit_inventory').' </a> 
											<a href="" class="flex items-center block p-2 transition duration-300 ease-in-out bg-white hover:bg-gray-200 rounded-md"> <i data-feather="external-link" class="w-4 h-4 text-gray-700 mr-2"></i> '.lang('items_edit_inventory').' </a> 
											<a href="" class="flex items-center block p-2 transition duration-300 ease-in-out bg-white hover:bg-gray-200 rounded-md"> <i data-feather="file-text" class="w-4 h-4 text-gray-700 mr-2"></i> '.lang('items_edit_inventory').' </a> 
											<a href="" class="flex items-center block p-2 transition duration-300 ease-in-out bg-white hover:bg-gray-200 rounded-md"> <i data-feather="archive" class="w-4 h-4 text-gray-700 mr-2"></i> '.lang('items_edit_inventory').' </a> 
										</div>
									</div>
								</div>
							</div>
