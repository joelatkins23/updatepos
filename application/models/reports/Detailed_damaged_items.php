...
class Detailed_damaged_items extends Report
{
	...
	public function getData()
	{
		...
		if (isset($this->params['show_summary_only']))
		{
			$this->db->select('SUM(phppos_damaged_items_log.damaged_qty) as damaged_qty,phppos_damaged_items_log.item_variation_id,items.*,locations.name as location_name',false);
