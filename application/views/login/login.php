            ...
            <div class="block xl:grid grid-cols-2 gap-4">
                ...
                <div class="h-screen xl:h-auto flex py-5 xl:py-0 my-10 xl:my-0">
                    <div class="my-auto mx-auto xl:ml-20 bg-white xl:bg-transparent px-5 sm:px-8 py-8 xl:p-0 rounded-md shadow-md xl:shadow-none w-full sm:w-3/4 lg:w-2/4 xl:w-auto">
                        ...
                        <div class="rounded-md px-5 py-4 mb-1 mt-4 bg-theme-6 text-white">
                            <strong><?php echo lang('common_error'); ?></strong>
                            <?php echo validation_errors(); ?>
                        </div>
                        <?php } ?>
                        <form action="<?php echo site_url('login?continue='.rawurlencode($this->input->get('continue'))) ?>" class="loginform" method="POST">
                            <div class="intro-x mt-2 text-gray-500 xl:hidden text-center">A few more clicks to sign in to your account. Manage all your e-commerce accounts in one place</div>
                            <div class="intro-x mt-8">
                                <input type="text" id="username" name="username" class="intro-x login__input input input--lg border border-gray-300 block" placeholder="<?php echo lang('login_username'); ?>">
                                <input type="password" id="password" name="password" class="intro-x login__input input input--lg border border-gray-300 block mt-4" placeholder="<?php echo lang('login_password'); ?>">
                            </div>
                            <div class="intro-x flex text-gray-700 text-xs sm:text-sm mt-4">
                                ...
                                <a href="<?php echo site_url('login/reset_password') ?>"><?php echo lang('login_reset_password').'?'; ?></a> 
                            </div>
                            <div class="intro-x mt-5 xl:mt-8 text-center xl:text-left">
                                <button type="submit" class="button button--lg w-full xl:w-32 text-white bg-theme-1 xl:mr-3"><?php echo lang('login_login'); ?></button>
                                <!-- <a class="button button--lg w-full xl:w-32 text-gray-700 border border-gray-300 mt-3 xl:mt-0">Sign up</a> -->
                            </div>
                        </form>
