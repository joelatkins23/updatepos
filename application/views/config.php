		...
		<div class="col-md-12">
			<div class="panel panel-piluku">
				...
				<div class="panel-body">
					...
					<!-- create Joel -->
					<div class="form-group" data-keyword="<?php echo H(lang('config_keyword_items')) ?>">	
						<?php echo form_label('Default Reorder Type:', '',array('class'=>'col-sm-3 col-md-3 col-lg-2 control-label ')); ?>
						<div class="col-sm-9 col-md-9 col-lg-10">
							<select name="reorder_level_select" id="reorder_level_select" class="form-control form-inps" require="required" >
								<option <?php if($this->config->item('reorder_level_select')=='fixed_value'){echo 'selected';} ?> value="fixed_value">Fixed value</option>	
								<option <?php if($this->config->item('reorder_level_select')=='percentage'){echo 'selected';} ?> value="percentage">Percentage</option>														
							</select>							
						</div>
					</div>
					<div class="form-group" data-keyword="<?php echo H(lang('config_keyword_items')) ?>" id="fixed_value_content" >	
					...
					<div class="form-group" style="display:none;" data-keyword="<?php echo H(lang('config_keyword_items')) ?>" id="percentage_content" >	
						<?php echo form_label('Percentage:', '',array('class'=>'col-sm-3 col-md-3 col-lg-2 control-label ')); ?>
						<div class="col-sm-9 col-md-9 col-lg-10">
							<?php echo form_input(array(
							'class'=>'form-control form-inps',
							'name'=>'default_percentage_when_creating_items',
							'id'=>'default_percentage_when_creating_items',
							'value'=>$this->config->item('default_percentage_when_creating_items')));?>
						</div>
					</div>
					<div class="form-group" data-keyword="<?php echo H(lang('config_keyword_items')) ?>"  >	
					<?php echo form_label('Default Value for Max Order Qty:', 'default_reorder_level_when_creating_items',array('class'=>'col-sm-3 col-md-3 col-lg-2 control-label ')); ?>
						<div class="col-sm-9 col-md-9 col-lg-10">
							<?php echo form_input(array(
							'class'=>'form-control form-inps',
							'name'=>'default_price_when_creating_items',
							'id'=>'default_price_when_creating_items',
							'value'=>$this->config->item('default_price_when_creating_items')));?>
						</div>
					</div>
					<!-- end Joel -->
					<div class="form-group" data-keyword="<?php echo H(lang('config_keyword_items')) ?>">	
...
{	
	// create joel
	if(<?php echo json_encode($this->config->item('reorder_level_select')); ?>){
		if(<?php echo json_encode($this->config->item('reorder_level_select')); ?>=='percentage'){
			$("#fixed_value_content").css("display","none");
			$("#percentage_content").css("display","block");
		}else if(<?php echo json_encode($this->config->item('reorder_level_select')); ?>=='fixed_value'){
			$("#fixed_value_content").css("display","block");
			$("#percentage_content").css("display","none");
		}
		
	}
	date_time_picker_field($('.timepicker'), JS_TIME_FORMAT);
	date_time_picker_field($('.datepicker'), 'YYYY-MM-DD');
	$("#reorder_level_select").on("change", function(e){
		if(e.target.value=='percentage'){
			$("#fixed_value_content").css("display","none");
			$("#percentage_content").css("display","block");
		}else if(e.target.value=='fixed_value'){
			$("#fixed_value_content").css("display","block");
			$("#percentage_content").css("display","none");
		}
	})
