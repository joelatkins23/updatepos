		...
		<div class="panel panel-piluku">
	      ...
	      <h3 class="panel-title"><i class="ion-location"></i> <?php echo $location->name; ?> <small>(<?php echo lang('common_fields_required_message'); ?>)</small></h3>
			...
			<div class="form-group">
				...
				<!-- create Jole -->
				<?php
					if( $location_items[$location->location_id]->item_id !== '' &&  $location_items[$location->location_id]->reorder_level !== NULL){
						$aaa=to_quantity($location_items[$location->location_id]->reorder_level);
					}else{
